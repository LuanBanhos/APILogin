            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        pessoa = _a.sent();
                        if (!pessoa) {
                            return [2 /*return*/, res.status(404).json({ msg: "Pessoa Não Encontrada" })];
                        }
                        return [2 /*return*/, res.status(200).json(pessoa)];
                    case 2:
                        error_2 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        pessoa = _a.sent();
                        if (!pessoa) {
                            return [2 /*return*/, res.status(404).json({ msg: "Pessoa não existe" })];
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        pessoa = _b.sent();
                        if (!pessoa) {
                            return [2 /*return*/, res.status(404).json({ msg: 'Email Não Encontrado' })];
                        }
